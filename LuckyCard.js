  ...
  LuckyCard.prototype.createCanvas = function() {
    ...
    if (this.opt.coverImg) {
      ...
      if(this.opt.coverText){
        this.ctx.font = ".8rem serif";
        this.ctx.fillStyle = this.opt.coverTextColor;
        this.ctx.textAlign = "center";
        this.ctx.fillText(this.opt.coverText,this.cover.width/2,this.cover.height/1.5);
      }
    }
  ...
  LuckyCard.prototype.eventDetect = function() {
    //移动端
    if (/(iPhone|iPad|iPod|iOS|Android)/i.test(navigator.userAgent))this.supportTouch = true;
